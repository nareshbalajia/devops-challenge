...
pipelineJob(job_name) {
  ...
  parameters {
    ...
    stringParam("TF_STATE_BUCKET_REGION", STATE_BUCKET_REGION, "Target region where state bucket is present")
    stringParam("TARGET_ACCOUNT", "", "The target account to deploy the VPC infrastructure")
